...
class ForgotAccountCertifyEmailReactorTests: XCTestCase {
    ...
    func testActions() throws {
        ...
        // 4. assert actions
        XCTAssertEqual(reactor.stub.actions.last, .checkValidation(email: DummyModel.email))
    ...
    func testStates() throws {
        ...
        XCTAssertEqual(viewController.forgotAccountCertifyEmailView.authNumberTextFieldView.textField.text, "dd")
