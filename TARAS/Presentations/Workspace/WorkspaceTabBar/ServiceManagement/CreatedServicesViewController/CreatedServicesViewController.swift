//
//  CreatedServicesViewController.swift
//  ServiceRobotPlatform-iOS
//
//  Created by nexmond on 2020/05/27.
...
class CreatedServicesViewController: BaseViewController, View {
    ...
    func bind(reactor: PagingCreatedServicesViewReactor) {
...
//            .disposed(by: self.disposeBag)
        ...
        self.collectionView.rx.modelSelected(ServiceCellReactor.self)
            .subscribe(onNext: { [weak self] reactor in
                ...
                self?.delegate?.didSelect(service, nil, true)
            })
            .disposed(by: self.disposeBag)
...
extension CreatedServicesViewController: UICollectionViewDelegate {
